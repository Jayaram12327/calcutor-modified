...
textbox.setAttribute("class","form-control border-success bg-light");
...
a.setAttribute("class","d-grid gap-2 col-6 mx-auto p-5");
...
div16.setAttribute("class","d-grid gap-2 col-12 mx-auto p-5");
